...
.nav {
  ...
  background: linear-gradient(180deg, rgba(255,255,255,0.06), rgba(255,253,248,0.04));
  -webkit-backdrop-filter: blur(24px) saturate(140%);
  backdrop-filter: blur(24px) saturate(140%);
  box-shadow:
    0 0 0 0.5px rgba(255,255,255,0.3),
    0 1px 1px rgba(100,80,40,0.02),
    0 4px 16px -8px rgba(100,80,40,0.05);
  transition: box-shadow .3s cubic-bezier(0.25,0.1,0.25,1), background .3s ease;
}
/* 墨金深色模式导航栏 */
.zg-inkgold-dark .nav {
  background: linear-gradient(180deg, rgba(32,27,20,0.18), rgba(26,22,16,0.12));
  -webkit-backdrop-filter: blur(24px) saturate(140%);
  backdrop-filter: blur(24px) saturate(140%);
  box-shadow:
